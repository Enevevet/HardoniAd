exports.run = (client, message, args) => {
	...
	if (message.author.id != `329669021043523594` && message.author.id != `362673558889037825` /* `376812375795302402`*/) return message.channel.send(`<:facepalm:474618049828356137> Nope...`);
	...
	if (!client.banned.has(user)) {
		message.channel.send(`<:facepalm:474618049828356137> Mais wtf ? Il est pas ban lui !`);
